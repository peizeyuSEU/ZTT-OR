...
2.  was the final inner-BP status, not an outer-GA global-optimality claim.
...
4. The paper table lacked scenario-level and paired network/investment/carbon fields.
