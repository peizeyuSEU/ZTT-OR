...
manifest=(RES/"A3_FINALIZATION_MANIFEST.txt").read_text()
if "interrupted_attempt_preserved: true" not in manifest: e.append("manifest preserved flag")
if "interrupted_attempt_in_formal_statistics: false" not in manifest: e.append("manifest formal-statistics flag")
if "interrupted_attempt_excluded:" in manifest: e.append("obsolete manifest field")
if "seed_808_official_source: attempt_05" not in manifest: e.append("manifest seed808 source")
