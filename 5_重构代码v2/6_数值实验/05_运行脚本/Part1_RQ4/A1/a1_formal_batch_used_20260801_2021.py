...
for sz,nd,nr in sizes:
  for wid,wv in ws:
    ...
    ctimes=[float(r.get("reference_total_wall_time_sec",r.get("cplex_wall_time_sec",0))) for r in g]; btimes=[float(r.get("bp_total_wall_time_sec",r.get("bp_wall_time_sec",0))) for r in g]
...
allg=[float(r["relative_objective_difference"])*100 for r in rows]; c=[float(r.get("reference_total_wall_time_sec",r.get("cplex_wall_time_sec",0))) for r in rows]; b=[float(r.get("bp_total_wall_time_sec",r.get("bp_wall_time_sec",0))) for r in rows]
