...
def finish(b):
 ...
 for scen in ('NO_INVESTMENT','OPTIMIZED_INVESTMENT'):
  ...
  for metric in ('total_profit','carbon_emission','total_investment_cost','num_dc_open','mean_positive_w','mean_all_w','max_w','wall_time_sec'):
